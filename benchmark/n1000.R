...
tic("Import measures")
import_measures_csv(
  csv_path = "./benchmark/csv_1000/measures_1000.csv",
  stat_unit = "PATIENT",
  date = "DATE",
  tag = "DESCRIPTION",
  value = "VALUE")
...
tic("Import events")
import_events_csv(
  csv_path = "./benchmark/csv_1000/events_1000.csv",
  stat_unit = "PATIENT",
  date = "DATE",
  tag = "DESCRIPTION")
toc()
...
tic("Import periods")
import_periods_csv(
  csv_path = "./benchmark/csv_1000/periods_1000.csv",
  stat_unit = "PATIENT",
  begin = "START",
  end = "STOP",
  tag = "DESCRIPTION")
...
import_stat_units_csv(
  csv_path = "./benchmark/csv_1000/patients_1000.csv",
  stat_unit = "UserId",
